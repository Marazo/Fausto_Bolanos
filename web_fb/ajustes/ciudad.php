...
<html>
  ...
  <body>
    <div class="w3-container w3-wide">
      ...
      <input class="ciudadNombre" placeholder="Ciudad" onKeyUp="this.value=this.value.toUpperCase();"><br><br>
      <button class="w3-button w3-round-xxlarge w3-signal-black ciudadIncertar">Aceptar</button><br><br>
        ...
        <?php
          if ($result = mysqli_query($mysqli, $consulta->sqlCiudad())) {
            while ($filas = mysqli_fetch_array($result)) {
              echo "
              <tr>
                <th>".utf8_encode($filas['ID_CIUDAD'])."</th>
